...
description: "Search retrieves candidate evidence. Memory also has to reconcile identity, authority, and time; construct different views for different tasks; and decide which reviewed results become reusable state."
layout: post
